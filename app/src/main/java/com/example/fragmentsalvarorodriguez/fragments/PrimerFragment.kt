...
import com.example.fragmentsalvarorodriguez.databinding.FragmentPrimerBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            irSegundo.setOnClickListener {
                val action = PrimerFragmentDirections.actionPrimerFragmentToSegundoFragment(Constants.PRIMER_MESSAGE)
                findNavController().navigate(action)
            }
            irTercero.setOnClickListener{
                val action = PrimerFragmentDirections.actionPrimerFragmentToTercerFragment(Constants.PRIMER_MESSAGE)
                findNavController().navigate(action)
            }
        }
    }
